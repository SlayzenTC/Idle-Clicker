...
pygame.display.set_caption("Idle Clicker version 20.1.1")
...
while running:
    ...
    if game_state == "menu":
        title_surf = big_font.render("Idle Clicker Version 20.1.1",True, BLACK)
        ...
        changes = [
            "v20.1.1 - Correction d'un bug d'affichage concernant la partie changelogs",
